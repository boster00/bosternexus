/**
 * BooksSalesOrderItemEntity
 * 
 * Entity definition for Zoho Books Sales Order Line Items.
 */

export class BooksSalesOrderItemEntity {
  static tableName = 'zoho_books_salesorder_items';
  ...
  static transformToDbRecord(zohoLineItem, relatedSalesOrderId) {
    const record = {
      related_salesorder_id: relatedSalesOrderId,
    };
