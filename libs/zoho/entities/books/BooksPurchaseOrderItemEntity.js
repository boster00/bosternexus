/**
 * BooksPurchaseOrderItemEntity
 * 
 * Entity definition for Zoho Books Purchase Order Line Items.
 */

export class BooksPurchaseOrderItemEntity {
  static tableName = 'zoho_books_purchaseorder_items';
  ...
  static transformToDbRecord(zohoLineItem, relatedPurchaseOrderId) {
    const record = {
      related_purchaseorder_id: relatedPurchaseOrderId,
    };
