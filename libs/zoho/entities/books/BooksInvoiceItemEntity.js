/**
 * BooksInvoiceItemEntity
 * 
 * Entity definition for Zoho Books Invoice Line Items.
 * Defines field mappings, transformations, and table structure.
 */

export class BooksInvoiceItemEntity {
  static tableName = 'zoho_books_invoice_items';
   ...
   * @param {string} relatedInvoiceId - UUID of parent invoice in database
   * @returns {object} Database-ready record
   */
  static transformToDbRecord(zohoLineItem, relatedInvoiceId) {
    const record = {
