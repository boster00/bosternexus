...
// For instance:
// - Hero: "Boster Nexus helps teams manage operations efficiently"
// - Problem Agitation: "Teams spend too much time managing multiple systems, get overwhelmed, and lose productivity." (not about Boster Nexus at all)
// - Features: "Boster Nexus has Zoho integration, inventory management, and workflow automation all set up for you"
const Problem = () => {
  return (
