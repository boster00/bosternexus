...
import marcImg from "@/app/(public)/blog/_assets/images/authors/marc.png";
...
export const categories = [
  {
    ...
    description:
      "Here are the latest features we've added to Boster Nexus. We're constantly improving our product to help you manage operations more efficiently.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to Boster Nexus.",
  },
  {
    ...
    description:
      "Learn how to use Boster Nexus with these step-by-step tutorials. We'll show you how to manage operations more efficiently and save time.",
    descriptionShort:
      "Learn how to use Boster Nexus with these step-by-step tutorials.",
  },
];
...
export const articles = [
  {
    ...
    title: "Introducing Supabase to Boster Nexus",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with Boster Nexus!",
    ...
    image: {
      ...
      alt: "Supabase and Boster Nexus logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to Boster Nexus</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your Boster Nexus project
